...
<body>
	...
	if (session.isNew()) {
		session.invalidate();
		if (application.getAttribute("almostUser") == null) {
	...
	<div class="afterHeader">
		...
		<h1 class="writing topElem" id="whatsYourEmail">A verification
			code has been sent to ${applicationScope.almostUser.email}. Please
		...
		<form method="post" action="emailVerifier" id="makeEmail">
			...
			<p class="mistake bottommargin">${applicationScope.errorMessage}</p>
		</form>
	</div>
