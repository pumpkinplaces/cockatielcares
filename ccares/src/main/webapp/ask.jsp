...
<body>
	...
	<nav class="big overContent">
		<ul class="amenu" id = "headerUL">
			...
			<li><a href="ask.jsp" class="current">Ask About It</a></li>
	...
	<div class="afterHeader">
		...
		<h1 class="writing">Any questions?</h1>
		<p class="writing">There are a few things you should definitely
			know about your pet!</p>
	</div>
